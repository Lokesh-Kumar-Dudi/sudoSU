...
class suxcor(Gtk.Box):
    def __init__(self,parent):
        self.parent = parent
        self.glade_file=str(Path(__file__).parent / "suxcor.glade")
        self.builder = Gtk.Builder()
        self.builder.add_from_file(self.glade_file)
        
        self.main_box = self.builder.get_object("suxcor")
        ...
        self.list = ["panel","vibroseis","ftwin","itwin","ntwin","ntrc","first"]
        self.append_wf_cmd = ""
        self.parameters=""
        ...
        for item in self.list:
            ...
            if type(obj)==type(Gtk.Entry()):
                ...
                if obj.get_active() :
                    ...
                    pass
        if self.parameters!="":
            self.command = "suxcor < infile "+ self.parameters + " >" + "outfile"
            self.append_wf_cmd ="suxcor < $infile "+ self.parameters + " >" + "$prefix.$infile"
    ...
    def run(self,widget):
        ...
        if len(self.parent.input_files)==len(self.parent.output_files):
            ...
            for i,input_file in enumerate(self.parent.input_files):
                cmd = "suxcor"+ " < " + input_file + " "+self.parameters \
    ...
    def help(self, widget):
        ...
        help_dlg.set_title("SUXCOR Help")
        help_dlg.show_all()


    def destroy(self, widget):
        self.main_box.destroy()
        self.parent.tabs['SUXCOR'] = 0


class nb_page(Gtk.Box):
    def __init__(self,parent):
        self.main_class = suxcor(parent)
