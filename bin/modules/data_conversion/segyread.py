...
class segyread(Gtk.Box):
    def __init__(self,parent):
        self.parent = parent
        self.glade_file=str(Path(__file__).parent/"segyread.glade")
        self.builder = Gtk.Builder()
        self.builder.add_from_file(self.glade_file)
        self.main_box = self.builder.get_object("segyread")
        self.title_box = self.builder.get_object("tab_title")
        self.builder.connect_signals(self)
        self.list = ['conv','ebcdic','over','trcwt','buff','hfile','bfile','xfile']
    ...
    def run(self, widget):
        ...
        if len(self.parent.input_files)==len(self.parent.output_files):
            ...
            for i,input_file in enumerate(self.parent.input_files):
                cmd = "segyread"+" > "+self.parent.output_files[i]+ " tape=" + input_file + " "+self.parameters \
    ...
    def destroy(self, widget):
        ...
        self.parent.tabs['SEGYREAD'] = 0


class nb_page(Gtk.Box):
    def __init__(self,parent):
        self.main_class = segyread(parent)
