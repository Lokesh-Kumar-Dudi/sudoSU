...
class susort(Gtk.Box):
    def __init__(self,parent):
        self.parent = parent
        self.glade_file=str(Path(__file__).parent/ "susort.glade")
        self.builder = Gtk.Builder()
        self.builder.add_from_file(self.glade_file)
        self.main_box = self.builder.get_object("susort")
    ...
    def set_parameters(self, button):
        ...
        self.command = "susort < infile "+ self.parameters + " >" + "outfile"
        self.append_wf_cmd ="susort< $infile "+ self.parameters + " >" + "$prefix.$infile"
    ...
    def run(self, widget):
        ...
        if len(self.parent.input_files)==len(self.parent.output_files):
            ...
            for i,input_file in enumerate(self.parent.input_files):
                cmd = "susort"+ " < " + input_file + " "+self.parameters \
    ...
    def help(self, widget):
        ...
        help_dlg.set_title("SUSORT Help")
        help_dlg.show_all()
        

    def destroy(self, widget):
        self.main_box.destroy()
        self.parent.tabs['SUSORT'] = 0
